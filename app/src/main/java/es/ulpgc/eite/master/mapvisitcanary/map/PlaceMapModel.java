...
public class PlaceMapModel
  ...
  public void initStore(Context managedContext){
    Log.d("VisitCanary.Map.Model", "initStore");
  ...
  */
  ...
  public void fillPlaceStoreFromAssets(Context managedContext){
    ...
    Log.d("VisitCanary.Map.Model", "fillPlaceStoreFromAssets: " + store.toJSONArray());
  }
  ...
  public void fillPlaceStoreFromResources(Context managedContext){
    ...
    Log.d("VisitCanary.Map.Model", "fillPlaceStoreFromResources: " + store.toJSONArray());
  }
